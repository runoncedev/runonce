...
export default function ExperienceCard({
 ...
 transition hover:dark:bg-gray-700/80 bg-gray-200/30 self-end justify-self-end border px-2 py-1 rounded-md border-transparent font-normal dark:bg-gray-700/30 "
            ...
            <div className="flex gap-6 items-center h-full">
              ...
              <button
                className="flex h-[38px] aspect-square items-center justify-center rounded-md bg-gray-200/30 transition  terminal:rounded-none  terminal:border-orange-500 terminal:bg-transparent hover:terminal:border dark:bg-gray-700/30 dark:hover:bg-gray-700/80"
